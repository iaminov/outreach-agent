...
class EmailSender:
    ...
    def __init__(self, smtp_server: str, smtp_port: int, username: str, password: str):
        ...
        logger.info(
            f"Email sender initialized for {username} via {smtp_server}:{smtp_port}"
        )

    def send_email(
        self, to_email: str, subject: str, body: str, from_email: str | None = None
    ) -> bool:
        """
    ...
    def send_bulk_emails(
        self, email_list: list, subject: str, body: str, from_email: str | None = None
    ) -> dict:
        """
        ...
        """
        results = {"total": len(email_list), "successful": 0, "failed": 0, "errors": []}
        ...
        logger.info(
            f"Bulk email completed: {results['successful']} successful, {results['failed']} failed"
        )
        return results
